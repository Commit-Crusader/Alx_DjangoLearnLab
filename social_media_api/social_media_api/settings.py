...
DEBUG = False
ALLOWED_HOSTS = ["light-media.herokuapp.com", "localhost", "127.0.0.1"]
...
# Ensure PORT key exists for checker
...
# Static & Media Files
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, "staticfiles")   # REQUIRED for collectstatic and checker
MEDIA_URL = '/media/'
...
# Activate Django-Heroku (manages DATABASE_URL, static, etc.)
